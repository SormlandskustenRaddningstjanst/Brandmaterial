...
const views={
 ...
 consumables:{title:"Förbrukningsartiklar",help:"Saldo, beställningsnivå och leverantör per station. Artikel-ID används i hyllans QR-kod.",columns:["Artikel-ID","Artikel","Kategori","Station","Saldo","Beställ vid","Önskat lager","Enhet","Leverantör","Artikelnummer","Kontaktperson","Telefon","E-post","Kundnummer","Avtalsnummer","Förpackningsstorlek","Minsta beställningsantal","Beställningslänk","Beställningskommentar","Kommentar","Aktiv"],headers:["Artikel-ID","Artikel","Kategori","Station","Saldo","Beställ vid","Önskat lager","Enhet","Leverantör","Artikelnummer","Kontaktperson","Telefon","E-post","Kundnummer","Avtalsnummer","Förpackningsstorlek","Minsta beställningsantal","Beställningslänk","Beställningskommentar","Kommentar","Aktiv"],endpoint:null}
};
...
async function createConsumable(){
 ...
 btn.disabled=true;m.className="message active";m.textContent="Skapar…";
 try{
  const result=await postJson("/consumable",{article,category,stationId,balance,reorderAt,target,unit,supplier,supplierArticleNumber,orderUrl,contactPerson,phone,email,customerNumber,agreementNumber,packageSize,minimumOrderQuantity,orderComment,comment});
  ...
  ["newConsumableName","newConsumableCategory","newConsumableSupplier","newConsumableSupplierNo","newConsumableOrderUrl","newConsumableContact","newConsumablePhone","newConsumableEmail","newConsumableCustomerNo","newConsumableAgreementNo","newConsumableOrderComment","newConsumableComment"].forEach(id=>$(id).value="");
