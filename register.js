...
function openNewMaterial(){
 ...
 station.innerHTML=(data.stations||[]).filter(x=>x.active&&String(x.name||"").trim().toLocaleLowerCase("sv-SE")==="nyköping").map(x=>"<option value='"+x.id+"'>"+esc(x.name)+"</option>").join(""); station.disabled=true;
